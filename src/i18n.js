...
const i18n = new createI18n({
    ...
    messages: {
        ru: {
            ...
            'priority-urgent-hard-short': 'СиС',
            'priority-non-urgent-easy-short': 'НеСиЛ',
            'priority-non-urgent-hard-short': 'НеСиС',
            ...
            'status-new': 'Альтернативный вариант',
            'status-in-work': 'В процессе выполнения',
            'status-done': 'Выполнено',
            'status-canceled': 'Не выполнено',
            'status-none': 'Без состояния',
